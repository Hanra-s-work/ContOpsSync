...
class InstallDockerComposeWindows:
    ...
    def test_class_install_docker_compose_windows(self) -> None:
        """ Test the class install docker-compose Windows """
        self.print_on_tty(
            self.tty.info_colour,
            "This is a test message from the install docker-compose Windows class\n"
        )
