...
class InstallDockerComposeRaspberryPi:
...
"""
    ...
    def test_class_install_docker_compose_raspberry_pi(self) -> None:
        """ Test the class install docker-compose raspberry pi """
        self.print_on_tty(
            self.tty.info_colour,
            "This is a test message from the install docker-compose raspberry pi class\n"
        )
