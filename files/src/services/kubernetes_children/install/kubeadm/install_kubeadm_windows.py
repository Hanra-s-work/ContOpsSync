...
class InstallKubeadmWindows:
    ...
    def test_class_install_kubeadm_windows(self) -> None:
        """ Test the class install kubeadm windows """
        self.print_on_tty(
            self.tty.info_colour,
            "This is a test message from the install kubeadm Windows class\n"
        )
