...
class InstallKubeadmLinux:
    ...
    def test_class_install_kubeadm_linux(self) -> None:
        """ Test the class install kubeadm linux """
        self.print_on_tty(
            self.tty.info_colour,
            "This is a test message from the install kubeadm Linux class\n"
        )
