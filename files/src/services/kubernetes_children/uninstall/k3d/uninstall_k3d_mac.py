"""
File in charge of containing the class that will install k3d for mac distributions.
"""
...
class UninstallK3dMac:
    """ The class in charge of uninstalling k3d for mac """
    ...
    def test_class_uninstall_k3d_mac(self) -> None:
